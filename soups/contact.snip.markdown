<div id="contact" class="section group" markdown="1">
...
* *Timing:* We're fairly booked up until the <em>end of 2017</em>, but we are likely to have some availability in early 2018. We'd love to hear from you if you've got an idea you think we can help with.
