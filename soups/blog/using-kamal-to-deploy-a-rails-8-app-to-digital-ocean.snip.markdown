...
Kamal expects to be able to push and pull container images to and from a registry during deployment so we use `doctl` to create a private Container Registry in Digital Ocean.
...
Visit https://cloud.digitalocean.com/account/api/tokens and create a new token:
...
This will allow us to create a Droplet that's configured for SSH authentication.
...
We add an entry to /etc/hosts to avoid having to edit DNS at this stage.
...
:author: chris-roos
:created_at: 2025-02-07 16:08:00 +00:00
:updated_at: 2025-02-07 16:08:00 +00:00
