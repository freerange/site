...
[<img alt="Cabinet Office page on GOV.UK" src="<%= image_path('blog/cabinet.thumb.png') %>" style="width: 100%"/>][government-cabinet]
...
[<img alt="Homelessness policy page on GOV.UK" src="<%= image_path('blog/policy.thumb.png') %>" style="width: 100%"/>][government-tackling-homelessness]
...
[<img alt="Consultations page on GOV.UK" src="<%= image_path('blog/consultations.thumb.png') %>" style="width: 100%"/>][government-consultations]
