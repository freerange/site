...
Outside of Jam, [James](/james-mead) has spent a bit of time working on adding the ability for customers to purchase multiple patches in a single order on [mission-patch.com](https://mission-patch.com/), and on investigating a [potential problem in Mocha](https://github.com/freerange/mocha/issues/763) as he [prepares for the release of v3.0.0](https://github.com/freerange/mocha/issues/736). And we all met in London yesterday to have lunch with [James Darling](https://abscond.org) and to spend the afternoon together to generally catch up over a couple of pints.
...
:name: week-877
:updated_at: 2025-11-07 10:47:47.458050672 +00:00
:created_at: 2025-11-07 10:47:47.458050269 +00:00
:render_as: Blog
:kind: blog
:is_page: true
:written_with: markdown
:author: chris-roos
:page_title: Weeks 875 to 877
:extension: markdown
